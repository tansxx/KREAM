...
class ProfileManageViewController: UIViewController {
    ...
    @objc private func handleEmailChange() {
        profileManageView.emailField.isUserInteractionEnabled.toggle()
        if profileManageView.emailField.isUserInteractionEnabled {
    ...
    @objc private func handlePwdChange() {
        profileManageView.pwdField.isUserInteractionEnabled.toggle()
        if profileManageView.pwdField.isUserInteractionEnabled {
